...
!1,this.selectedKey={}):(this.selectedKey.selected=!1,this.selectedKey=this.lines[a].keys[d],this.selectedKey.selected=!0),this.canvas.dispatchEvent(new Event("keyClick")))};
