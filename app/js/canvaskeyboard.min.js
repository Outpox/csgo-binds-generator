...
CanvasRenderingContext2D.prototype._roundRect=function(c,a,b,e,d,f,g){if(0!==d&&1!==d){"undefined"==typeof g&&(g=!0);"undefined"===typeof d&&(d=5);if("number"===typeof d)d={tl:d,tr:d,br:d,bl:d};else{var h={tl:0,tr:0,br:0,bl:0},k;for(k in h)d[k]=d[k]||h[k]}this.beginPath();this.moveTo(c+d.tl,a);this.lineTo(c+b-d.tr,a);this.quadraticCurveTo(c+b,a,c+b,a+d.tr);this.lineTo(c+b,a+e-d.br);this.quadraticCurveTo(c+b,a+e,c+b-d.br,a+e);this.lineTo(c+d.bl,a+e);this.quadraticCurveTo(c,a+e,c,a+e-d.bl);this.lineTo(c,
a+d.tl);this.quadraticCurveTo(c,a,c+d.tl,a);this.closePath();f&&this.fill();g&&this.stroke()}else this.rect(c,a,b,e),this.fill(),this.stroke()};CanvasRenderingContext2D.prototype._roundPoly=function(c,a){for(var b=c.data.shape,e=null,d=null,f=0;f<b.length;f++)switch(e=b[f].x,d=b[f].y,b[f]["function"]){case "moveTo":this.moveTo(parseInt(c.startX+e),parseInt(c.startY+d));break;case "lineTo":this.lineTo(parseInt(c.startX+e),parseInt(c.startY+d))}this.stroke();this.fill()};
CanvasRenderingContext2D._customShape=function(c){for(var a=c.data.customShape,b=0;b<a.length;b++){var e=a[b]["function"],d=a[b].x,f=a[b].y;"moveTo"===e&&this.moveTo(parseInt(c.startX+d),parseInt(c.startY+f));"lineTo"===e&&this.lineTo(parseInt(c.startX+d),parseInt(c.startY+f))}this.stroke();this.fill()};
(function(){function c(a,b){b=b||{bubbles:!1,cancelable:!1,detail:void 0};var c=document.createEvent("CustomEvent");c.initCustomEvent(a,b.bubbles,b.cancelable,b.detail);return c}c.prototype=window.Event.prototype;window.CustomEvent=c})();var idKeyboardCount=0;
function Keyboard(c,a,b,e){var d=c.getBoundingClientRect();this.id=idKeyboardCount++;this.layout=a.layout||"keyboards/qwerty_uk.json";this.canvas=c;this.context=c.getContext("2d");this.keyWidth=a.keyWidth||40;this.keyHeight=a.keyHeight||40;this.offsetX=parseInt(d.left)||0;this.offsetY=parseInt(d.top)||0;this.defaultCursor=a.defaultCursor||"auto";this.hoverCursor=a.hoverCursor||"pointer";this.disabledCursor=a.disabledCursor||"auto";this.backgroundColor=a.backgroundColor||c.style.backgroundColor||"white";
...
Key.prototype.draw=function(c,a){a=a||!1;var b=this.line.context,e=this.startX+this.lengthX/2,d=b.measureText("I").width+this.startY+this.lengthY/2,f=a?this.selected?this.line.keyboard.keySelectedHoverBorderRadius:this.line.keyboard.keyHoverBorderRadius:this.selected?this.line.keyboard.keySelectedBorderRadius:this.line.keyboard.keyBorderRadius;b.save();b.beginPath();this.disabled&&(b.globalAlpha=.5);b.fillStyle=a?this.selected?this.line.keyboard.keySelectedHoverBackgroundColor:this.active?this.line.keyboard.keyActiveBackgroundColor:
this.line.keyboard.keyHoverBackgroundColor:this.selected?this.line.keyboard.keySelectedBackgroundColor:this.active?this.line.keyboard.keyActiveBackgroundColor:this.line.keyboard.keyBackgroundColor;b.strokeStyle=c||(this.selected?this.line.keyboard.keySelectedBorderColor:this.line.keyboard.keyBorderColor);b.lineWidth=a?this.selected?this.line.keyboard.keySelectedHoverBorderWidth:this.line.keyboard.keyHoverBorderWidth:this.selected?this.line.keyboard.keySelectedBorderWidth:this.line.keyboard.keyBorderWidth;
"custom"===this.type?(e=this.startX+this.data.customWidth/2||e,d=this.startX+this.data.customHeight/2||d):("square"===this.type&&(this.lengthX=this.data.customWidth||this.lengthX,this.lengthY=this.data.customHeight||this.lengthY,e=this.startX+this.lengthX/2||e,d=b.measureText("I").width+this.startY+this.lengthY/2),b._roundRect(this.startX,this.startY,this.lengthX,this.lengthY,parseInt(f),!0,!0));b.font=a?this.selected?this.line.keyboard.keySelectedHoverFontType:this.line.keyboard.keyHoverFontType:
this.selected?this.line.keyboard.keySelectedFontType:this.line.keyboard.keyFontType;b.textAlign="center";b.fillStyle=a?this.selected?this.line.keyboard.keySelectedHoverFontColor:this.line.keyboard.keyHoverFontColor:this.selected?this.line.keyboard.keySelectedFontColor:this.line.keyboard.keyFontColor;b.fillText(this.content,e,d);b.restore()};
...
return b};Key.prototype.getValue=function(){return void 0!==this.data.value?this.data.value:this.content};
